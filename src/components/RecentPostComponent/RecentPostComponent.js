...
const RecentPostCardComponent = () => {
    return (
        <ElevatedCard className="recent-post-outer-div"
            ...
            <ContentWrapper>
                ...
                <div>
                    <Row>
                        <Col style={{ maxWidth: '30%' }} >
                            ...
                            <img src="https://images.unsplash.com/photo-1590673846749-e2fb8f655df8?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80" className="image-style-recent-post" alt="postmedia" />
                        </Col>
                        <Col>
                            <Typography
                                style={{ marginBottom: "20px" }}
                            ...
                            <Typography color="#F08D32" fontSize={10} fontType="caps" fontWeight={700}>
                ...
                <div>
                    <Row>
                        <Col style={{ maxWidth: '30%' }} >
                            {/* <img src="https://images.unsplash.com/photo-1511556532299-8f662fc26c06?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80" className="image-style" alt="postmedia" /> */}
                            <img src="https://images.unsplash.com/photo-1566363384123-360c5f6bc369?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1073&q=80" className="image-style-recent-post" alt="postmedia" />
                        </Col>
                        <Col>
                            <Typography
                                style={{ marginBottom: "20px" }}
